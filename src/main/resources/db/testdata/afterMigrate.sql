...
VALUES
('100', 'ivan@mail.com', 'ivan', 'ACTIVE', 'Іван', 'Іванов', 'Лікар вищої категорії', '+380969696969'
...
('200', 'andrii@mail.com', 'andrii', 'ACTIVE', 'Андрій', 'Петров', 'Лікар-спеціаліст', '+380505050505'
, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna ' ||
 'aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ' ||
  'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur ' ||
   'sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
('300', 'olena@mail.com', 'olena', 'ACTIVE', 'Олена', 'Шевченко', 'Кандидат медичних наук', '+380939393939'
, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna ' ||
 'aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ' ||
  'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur ' ||
   'sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
('400', 'dmytro@mail.com', 'dmytro', 'ACTIVE', 'Дмитро', 'Степаненко', 'Лікар-спеціаліст', '+380444444444'
, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna ' ||
 'aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ' ||
  'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur ' ||
   'sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
('500', 'kateryna@mail.com', 'kateryna', 'ACTIVE', 'Катерина', 'Кравченко', 'Кандидат медичних наук', '+380989898989'
, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna ' ||
 'aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ' ||
  'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur ' ||
   'sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
('600', 'oleh@mail.com', 'oleh', 'ACTIVE', 'Олег', 'Петренко', 'Кандидат медичних наук', '+380939393939'
, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna ' ||
 'aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ' ||
  'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur ' ||
   'sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
('700', 'tetyana@mail.com', 'tetyana', 'ACTIVE', 'Тетяна', 'Коваленко', 'Лікар вищої категорії', '+380444444444'
, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna ' ||
 'aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ' ||
  'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur ' ||
   'sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
('800', 'maryna@mail.com', 'maryna', 'ACTIVE', 'Марина', 'Вовк', 'Лікар-спеціаліст', '+380939393939'
, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna ' ||
 'aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ' ||
  'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur ' ||
   'sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
('900', 'admin@mail.com', 'admin', 'ACTIVE', 'Gregory', 'House', 'Адмін', '+380939393939'
, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna ' ||
 'aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. ' ||
  'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur ' ||
   'sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
...
('100', '1'), ('100', '2'), ('100', '5'), ('200', '2'), ('200', '5'), ('300', '1'), ('300', '2'), ('400', '1'), ('400', '5'), ('500', '3'),
('600', '4'), ('700', '1'), ('700', '5'), ('800', '3')
ON CONFLICT DO NOTHING;
...
('1', '900'), ('2', '400'), ('3', '200'), ('2', '100'), ('3', '300'), ('2', '500'), ('3', '700'), ('2', '600'), ('3', '800')
ON CONFLICT DO NOTHING;


INSERT INTO PUBLIC.USERS_DIRECTIONS (USER_ID, DIRECTION_ID) VALUES
('100', '2'), ('100', '3'), ('100', '5'), ('200', '1'), ('200', '3'), ('200', '5'), ('300', '1'), ('300', '2'), ('300', '3'),
('400', '3'), ('400', '4'), ('400', '5'), ('500', '1'), ('500', '3'), ('500', '5'), ('600', '2'), ('600', '3'), ('600', '4'),
('700', '1'), ('700', '4'), ('700', '5'), ('800', '3'), ('800', '4'), ('800', '5')
ON CONFLICT DO NOTHING;


INSERT INTO PUBLIC.CHARITIES (CHARITY_ID, BODY, CREATED_AT, MODIFIED_AT, AUTHOR_ID) VALUES
('1', 'Lorem ipsum - 50шт. Ut enim - 10шт.', NOW(), NOW(), 200),
('2', 'Ut enim - 5шт. ipsum - 20шт.', NOW(), NOW(), 400),
('3', 'Lorem - 500шт. Ut enim - 100шт.', NOW(), NOW(), 600),
('4', 'Ut enim - 10шт. Excepteur sint - 200шт.', NOW(), NOW(), 700)
ON CONFLICT DO NOTHING;


INSERT INTO PUBLIC.SOURCES (SOURCE_ID, TYPE, VALUE, USER_ID) VALUES
('1', 'PROFILE_IMAGE', 'https://i.imgur.com/I80W1Q0.png', '100'),
('2', 'PROFILE_IMAGE', 'https://i.pinimg.com/originals/51/f6/fb/51f6fb256629fc755b8870c801092942.png', '200'),
('3', 'PROFILE_IMAGE', 'https://html5css.ru/howto/img_avatar2.png', '300'),
('4', 'PROFILE_IMAGE', 'https://www.publicdomainpictures.net/pictures/270000/velka/avatar-people-person-business-u.jpg', '400'),
('5', 'PROFILE_IMAGE', 'https://cnet2.cbsistatic.com/img/liJ9UZA87zs1viJiuEfVnL7YYfw=/940x0/2020/05/18/5bac8cc1-4bd5-4496-a8c3-66a6cd12d0cb/fb-avatar-2.jpg', '500'),
('6', 'PROFILE_IMAGE', 'https://www.striketwosummit.com/wp-content/uploads/2019/04/avatar-1606916_960_720.png', '600'),
('7', 'PROFILE_IMAGE', 'https://www.pinclipart.com/picdir/middle/155-1559325_female-avatar-clipart.png', '700'),
('8', 'PROFILE_IMAGE', 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcR3F3e5C2_4KVWpSSvmBDVb8iPGyRnDB5DVPA&usqp=CAU', '800'),
('9', 'PROFILE_IMAGE', 'https://pickaface.net/gallery/avatar/20130319_083314_1174_admin.png', '900'),
('10', 'POST_IMAGE', 'https://www.afd.fr/sites/afd/files/styles/visuel_principal/public/2019-10-09-27-46/flickr-marco-verch.jpg?itok=XH4x7-Y4', '400'),
('11', 'POST_IMAGE', 'https://www.everest.ua/wp-content/uploads/2020/04/6_result-4.jpg', '100'),
('12', 'POST_IMAGE', 'https://epsilon.aeon.co/images/afef287f-dd6f-4a6a-b8a6-4f0a09330657/idea_sized-kendal-l4ikccachoc-unsplash.jpg', '100'),
('13', 'POST_IMAGE', 'https://blogs.biomedcentral.com/on-medicine/wp-content/uploads/sites/6/2018/06/2017-08-30-07-09-32-1000x667-620x342.jpg', '400'),
('14', 'POST_VIDEO', 'https://www.youtube.com/watch?v=YdzH6iIY1PQ&ab_channel=%D0%A2%D0%A1%D0%9D', '700'),
('15', 'POST_VIDEO', 'https://www.youtube.com/watch?v=vEabuIRTJ2M&ab_channel=%D0%9C%D0%B0%D0%BC%D0%B5%D0%B4%D1%8B%D1%87-%D0%96%D0%B8%D0%B7%D0%BD%D1%8C%D1%85%D0%B8%D1%80%D1%83%D1%80%D0%B3%D0%B0', '100'),
('16', 'POST_VIDEO', 'https://www.youtube.com/watch?v=a24CJXQJdyU&ab_channel=%D0%92%D1%96%D0%BA%D0%BD%D0%B0-%D0%BD%D0%BE%D0%B2%D0%B8%D0%BD%D0%B8', '100'),
('17', 'POST_VIDEO', 'https://www.youtube.com/watch?v=03yciZyoVRI&ab_channel=%D0%9B%D1%96%D0%BA%D0%B0%D1%80%D0%AE%D1%80%D1%96%D0%B9%D0%A1%D0%BE%D0%BB%D0%BE%D0%B4%D0%BE%D0%B2', '700')
ON CONFLICT DO NOTHING;
 ...
 'Malesuada proin libero nunc consequat interdum varius sit. Mauris cursus mattis molestie a. Est ullamcorper eget ' ||
  'nulla facilisi etiam dignissim diam. Risus ultricies tristique nulla aliquet enim tortor at. Diam quis enim lobortis ' ||
   'scelerisque fermentum. Tempor commodo ullamcorper a lacus vestibulum. Erat nam at lectus urna. Dui id ornare arcu ' ||
    'odio ut sem nulla pharetra.', NOW(), TRUE, NOW(), 'PUBLISHED', 'Fermentum iaculis', '200', '3', '1'),
...
('2', 'Integer eget aliquet nibh praesent tristique magna sit amet purus. Dolor purus non enim praesent elementum ' ||
 'facilisis leo. Porttitor eget dolor morbi non. Urna cursus eget nunc scelerisque viverra. Imperdiet massa tincidunt ' ||
  ...
  NOW(), 'MODERATION_SECOND_SIGN', 'Integer eget aliquet', '500', '2', '1'),
...
('4', 'Massa eget egestas purus viverra accumsan. Porta non pulvinar neque laoreet suspendisse interdum consectetur' ||
 ...
 NOW(), 'PUBLISHED', 'Massa eget egestas', '600', '1', '2'),
...
('6', 'Varius vel pharetra vel turpis nunc eget. Nisl tincidunt eget nullam non nisi est sit amet facilisis. ' ||
 'Integer eget aliquet nibh praesent tristique magna sit amet purus. Dolor purus non enim praesent elementum ' ||
  'facilisis leo.', NOW(), FALSE, NOW(), 'ARCHIVED', 'Sit amet consectetur', '400', '2', '3'),
...
('7', 'Ullamcorper malesuada proin libero nunc consequat. Sit amet consectetur adipiscing elit pellentesque habitant ' ||
 ...
 'Proin nibh nisl condimentum', '100', '1', '2'),
